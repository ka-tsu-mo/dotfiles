# Generated by Powerlevel10k configuration wizard on 2019-08-04 at 15:06 JST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 45532.
# Wizard options: awesome-fontconfig, large icons, classic, lightest, flat tails,
# 2 lines, solid, left frame, sparse, many icons, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%247F|'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%247F|'
  ...
  # Green prompt symbol if the last command succeeded. -> blue
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=31
  ...
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%f:%231F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%f#%231F${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %231F⇣${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%231F⇡${VCS_STATUS_COMMITS_AHEAD}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %231F*${VCS_STATUS_STASHES}}'
  # 'merge' if the repo is in an unusual state.
  vcs+='${VCS_STATUS_ACTION:+ %231F${VCS_STATUS_ACTION//\%/%%}}' # 196
  # ~42 if have merge conflicts.
  vcs+='${${VCS_STATUS_NUM_CONFLICTED:#0}:+ %231F~${VCS_STATUS_NUM_CONFLICTED}}' # 196
  # +42 if have staged changes.
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ %231F+${VCS_STATUS_NUM_STAGED}}' # 227
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %231F!${VCS_STATUS_NUM_UNSTAGED}}' # 227
  # ?42 if have untracked files. It's really a question mark, your font isn't broken.
  # See POWERLEVEL9K_VCS_UNTRACKED_ICON below if you want to use a different icon.
  # Remove the next line if you don't want to see untracked files at all.
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %231F${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}}' # 39
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=231 # 76
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=106
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=231 # 76
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=132
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=231
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=231
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='↵'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=160
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=231
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=231
  ...
  typeset -g POWERLEVEL9K_DATE_BACKGROUND=106
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=231
